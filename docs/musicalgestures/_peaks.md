...
> Auto-generated documentation for [musicalgestures._peaks](https://github.com/fourMs/MGT-python/blob/master/musicalgestures/_peaks.py) module.

Canonical adaptive peak-picking for sound and motion signals.

- [Mgt-python](../README.md#mgt-python) / [Modules](../MODULES.md#mgt-python-modules) / [Musicalgestures](index.md#musicalgestures) / Peaks
...
[[find in source code]](https://github.com/fourMs/MGT-python/blob/master/musicalgestures/_peaks.py#L19)
