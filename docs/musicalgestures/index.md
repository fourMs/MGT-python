...
- [Mgt-python](../README.md#mgt-python) / [Modules](../MODULES.md#mgt-python-modules) / Musicalgestures
    ...
    - Modules
        ...
        - [Eulerian](_eulerian.md#eulerian)
        ...
        - [Movementbeats](_movementbeats.md#movementbeats)
        - [Pipeline](_pipeline.md#pipeline)
        - [Pose](_pose.md#pose)
        - [PoseEstimator](_pose_estimator.md#poseestimator)
        - [Pose Visualize](_pose_visualize.md#pose-visualize)
        - [Show](_show.md#show)
...
[[find in source code]](https://github.com/fourMs/MGT-python/blob/master/musicalgestures/__init__.py#L25)
