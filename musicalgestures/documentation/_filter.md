...
> Auto-generated documentation for [_filter](https://github.com/fourMs/MGT-python/blob/master/_filter.py) module.
...
[[find in source code]](https://github.com/fourMs/MGT-python/blob/master/_filter.py#L6)
