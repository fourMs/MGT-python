...
def advanced_video_processing():
    ...
    motion_result = mv.motion(
        ...
        target_name_mgx='pianist_mgx',
        target_name_mgy='pianist_mgy'
    )
    ...
    motiongrams_result = mv.motiongrams(
        target_name_mgx='pianist_motiongrams_mgx',
        target_name_mgy='pianist_motiongrams_mgy'
    )
    
    print(f"   ✅ Motiongrams complete")
    ...
    avg_median = mv.average(
        method='median',
        target_name=f"{output_dir}/pianist_average_median"
    )
    
    print(f"   ✅ Mean and median averages complete")
    ...
    print(f"   ✅ Motion history analysis complete")
